 ...
 *
 * IMPORTANT: The route must use express.raw({ type: '*' + '/*' }) BEFORE this
 * is called so that req.body is a raw Buffer, not a parsed JSON object.
...
export const verifyWebhookSignature = (rawBody, headers) => {
    ...
    if (!svixId || !svixTimestamp || !svixSignature) {
        console.warn('Clerk webhook missing Svix headers - rejecting')
