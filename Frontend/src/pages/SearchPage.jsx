...
import { InstantSearch, SearchBox, Hits, Pagination, RefinementList, Configure, useInstantSearch } from 'react-instantsearch'
...
// Search Results Component to handle conditional rendering
function SearchResults() {
    ...
    // Render hits if there are results
    return (
        <Hits
            hitComponent={Hit}
            classNames={{
            ...
            <InstantSearch searchClient={searchClient} indexName="intelligrid_tools">
                ...
                <div className="flex flex-col gap-8 lg:flex-row">
                    ...
                    <div className="flex-1">
                        ...
                        <Pagination
                            classNames={{
                                root: 'flex items-center justify-center space-x-2 mt-8',
