        ...
        <div className="min-h-screen bg-gradient-to-b from-primary-900 to-deep-space">
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-lg prose-invert max-w-none space-y-6">
                    ...
                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">1.1 Information You Provide</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">1.2 Information Collected Automatically</h3>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">3. Cookies and Tracking Technologies</h2>

                    <p className="text-gray-300">We use cookies and similar technologies to enhance your experience:</p>

                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">3.1 Types of Cookies</h3>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300">You can control cookies through your browser settings. Note that disabling essential cookies may affect platform functionality.</p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">4. Third-Party Services</h2>

                    <p className="text-gray-300">We use the following third-party services that may collect your information:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300">Each service has its own privacy policy. We recommend reviewing their policies to understand how they handle your data.</p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">5. Data Sharing and Disclosure</h2>
                    ...
                    <p className="mt-4 text-gray-300"><strong>We do NOT sell your personal information to third parties.</strong></p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">6. Data Retention</h2>

                    <p className="text-gray-300">We retain your information for as long as necessary to provide the Service and comply with legal obligations:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300">You can request deletion of your data at any time (see Section 9).</p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">7. Data Security</h2>

                    <p className="text-gray-300">We implement industry-standard security measures to protect your information:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300">However, no method of transmission over the Internet is 100% secure. We cannot guarantee absolute security.</p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">8. International Data Transfers</h2>

                    <p className="text-gray-300">Your information may be transferred to and processed in countries other than your country of residence, including India and the United States. We ensure appropriate safeguards are in place for international transfers, including:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">9. Your Privacy Rights</h2>

                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">9.1 General Rights (All Users)</h3>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">9.2 GDPR Rights (European Users)</h3>
                    <p className="text-gray-300">If you are located in the European Economic Area (EEA), UK, or Switzerland, you have additional rights under GDPR:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300"><strong>Legal Basis for Processing (GDPR):</strong></p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">9.3 CCPA/CPRA Rights (California Users)</h3>
                    <p className="text-gray-300">If you are a California resident, you have rights under the California Consumer Privacy Act (CCPA) and California Privacy Rights Act (CPRA):</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300"><strong>California Categories of Personal Information Collected:</strong></p>
                    ...
                    <p className="mt-4 text-gray-300"><strong>We do NOT sell or share personal information for cross-context behavioral advertising.</strong></p>

                    <h3 className="text-xl font-semibold mt-6 mb-3 text-white">9.4 CalOPPA Compliance (California)</h3>
                    <p className="text-gray-300">Under California Online Privacy Protection Act (CalOPPA):</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">10. Children's Privacy (Under 13)</h2>
                    ...
                    <p className="mt-4 text-gray-300"><strong>Age Verification:</strong> By creating an account, you represent that you are at least 18 years old. Users between 13-17 must have parental consent.</p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">11. Marketing Communications</h2>

                    <p className="text-gray-300">We may send you marketing emails about:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300"><strong>Opt-Out:</strong> You can unsubscribe from marketing emails at any time by:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">12. Changes to This Privacy Policy</h2>

                    <p className="text-gray-300">We may update this Privacy Policy from time to time. When we make material changes, we will:</p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <p className="mt-4 text-gray-300">Continued use of the Service after changes constitutes acceptance of the updated Privacy Policy.</p>

                    <h2 className="text-2xl font-bold mt-8 mb-4 text-white">13. Contact Us</h2>

                    <p className="text-gray-300">If you have questions, concerns, or requests regarding this Privacy Policy or our data practices:</p>
                    ...
                    <div className="mt-12 pt-6 border-t border-white/10">
                        <p className="text-sm text-gray-400">
                            Related Documents: <Link to="/terms-of-service" className="text-accent-cyan hover:underline">Terms of Service</Link> | <Link to="/refund-policy" className="text-accent-cyan hover:underline">Refund Policy</Link>
                        </p>
                    </div>

                    <div className="mt-8 p-4 bg-accent-cyan/10 border-l-4 border-accent-cyan rounded-xl">
                        <p className="text-sm text-gray-300"><strong className="text-white">Summary:</strong> We collect information to provide our AI tools directory service, process subscriptions, and improve your experience. We don't sell your data. You have rights to access, delete, and control your information. Contact us anytime with questions.</p>
                    </div>
                </div>
            </div>
        </div>
