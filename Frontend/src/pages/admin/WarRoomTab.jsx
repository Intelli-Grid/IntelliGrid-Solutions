...
// VITE_API_URL includes /api/v1 — use it so all war-room paths are correctly versioned.
const API_BASE = (import.meta.env.VITE_API_URL || 'https://api.intelligrid.online/api/v1').replace(/\/+$/, '')
