...
function TermsOfServicePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-primary-900 to-deep-space">
            <SEO
                title="Terms of Service | IntelliGrid - Legal Agreement"
                description="Read IntelliGrid's Terms of Service. Understand your rights and responsibilities when using our AI tools directory platform. Clear, transparent legal terms."
                keywords="terms of service, legal agreement, user agreement, IntelliGrid terms, terms and conditions"
                canonicalUrl="https://www.intelligrid.online/terms-of-service"
            />
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-6">
                        ...
                        <span className="text-sm font-medium text-white">Legal Agreement</span>
                    </div>
                ...
                <div className="prose prose-lg prose-invert max-w-none space-y-6">
                    ...
                    <div className="mt-8 p-4 bg-accent-cyan/10 border-l-4 border-accent-cyan rounded-xl">
                        <p className="text-sm text-gray-300"><strong className="text-white">By using IntelliGrid, you agree to these Terms of Service. Please read them carefully.</strong></p>
                    </div>
                </div>
            </div>
        </div>
